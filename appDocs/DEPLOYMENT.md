...
This deploys DocuMind_AI 's frontend and API to Vercel, and its auth/database
...
help on Vercel — files larger than ~4 MB will fail with `413 FUNCTION_PAYLOAD_TOO_LARGE` before the app's own limit is ever checked. Set
